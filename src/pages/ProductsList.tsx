...
const ProductsList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch("/api/comments/?page=products", {
    ...
    fetch("/api/profile/", {
      ...
      .then((data) => {
        ...
        // Ensure backend returns only "admin" or "user" for role
  ...
  const handleAddComment = async (content: string) => {
    const res = await fetch("/api/comments/", {
      ...
      body: JSON.stringify({ content, page: "products" }),
    });
    if (res.ok) {
        ...
        <main className="flex-1 p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mt-1">
              Manage and discuss product catalog
            </p>
          </div>
          <div className="grid grid-cols-1 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600">
                This is the Products List page. Use the comment section below to
                collaborate and share information related to product management.
